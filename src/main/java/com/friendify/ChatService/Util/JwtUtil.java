...
public class JwtUtil {
    ...
    public String generateToken(UserCustomDetailService userDetails) {
    ...
    public boolean validateToken(String token, UserCustomDetailService userDetails) {
    ...
    private static String generateSafeToken(){
        ...
        byte[] bytes = new byte[65]; // 36 bytes * 8 = 288 bits, a little bit more than
